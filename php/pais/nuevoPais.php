...
<div id="seccion-pais">
	<div class="box-header">
    	<i class="fa fa-building" aria-hidden="true">Gestión de Paices</i>
        <!-- tools box -->
        <div class="pull-right box-tools">
            <button class="btn btn-info btn-sm btncerrar2" data-toggle="tooltip" 
        ...
        <div class="panel-group"><div class="panel panel-primary">
            ...
            <div class="panel-body">
                ...
                <form class="form-horizontal" role="form"  id="fpais">
                    ...
                    <div class="form-group">
                        <label class="control-label col-sm-2" for="pais_capi">Nacionalidad Pais : </label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="pais_capi" name="pais_capi"  placeholder="Ingrese Nacionalidad del Pais">
